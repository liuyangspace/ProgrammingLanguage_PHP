...
class ConnectionException extends \MongoDB\Driver\Exception\RuntimeException implements \MongoDB\Driver\Exception\Exception // MongoDB\Driver\Exception\ConnectionException
{
    /**
     * 继承的成员
     *
