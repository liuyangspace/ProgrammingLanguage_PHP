...
class SSLConnectionException extends \MongoDB\Driver\Exception\ConnectionException implements \MongoDB\Driver\Exception\Exception // MongoDB\Driver\Exception\SSLConnectionException
{
    /**
     * 继承的成员
     *
