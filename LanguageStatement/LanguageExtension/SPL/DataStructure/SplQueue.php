...
class SplQueue extends \SplQueue  implements \Iterator, \ArrayAccess, \Countable // extends SplDoublyLinkedList
{

    public function __construct(){parent::__construct();}
    public function enqueue($value){parent::enqueue($value);}//Adds an element to the queue
    public function dequeue(){return parent::dequeue();}//Dequeues a node from the queue
