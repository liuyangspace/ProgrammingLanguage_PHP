...
class AuthenticationException extends \MongoDB\Driver\Exception\ConnectionException implements \MongoDB\Driver\Exception\Exception // MongoDB\Driver\Exception\AuthenticationException
{
    /**
     * 继承的成员
     *
